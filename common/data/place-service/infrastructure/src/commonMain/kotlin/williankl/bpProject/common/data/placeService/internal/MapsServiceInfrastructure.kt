...
internal class MapsServiceInfrastructure(
    ...
    override suspend fun placeFromCoordinates(coordinates: MapCoordinate): MapPlaceResult {
    ...
    private suspend fun retrieveAddressFromCoordinate(coordinates: MapCoordinate){
        TODO()
    }
